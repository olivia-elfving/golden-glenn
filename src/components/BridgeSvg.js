...
const BridgeSvg = ({ raise }) => (
    ...
    {/*<g id="ghost-solid.svg" transform="matrix(0.11273,0,0,0.11273,809.161,67.8185)">
        <g transfrm="matrix(1,0,0,1,-192,-256)">
    ...
    <g id="ghosts" opacity="0">
        <g  transform="matrix(0.11273,0,0,0.11273,809.161,67.8185)" fill="yellow">
            <path d="M50.8,452.1L19.2,477.4C17.1,479.1 14.5,480 11.8,480C5.3,480 0,474.7 0,468.2L0,192C0,86 86,0 192,0C298,0 384,86 384,192L384,468.2C384,474.7 378.7,480 372.2,480C369.5,480 366.9,479.1 364.8,477.4L333.2,452.1C329.9,449.4 325.7,448 321.4,448C315.5,448 309.9,450.8 306.4,455.5L268.8,505.6C265.8,509.6 261,512 256,512C251,512 246.2,509.6 243.2,505.6L204.8,454.4C201.8,450.4 197,448 192,448C187,448 182.2,450.4 179.2,454.4L140.8,505.6C137.8,509.6 133,512 128,512C123,512 118.2,509.6 115.2,505.6L77.6,455.5C74,450.8 68.5,448 62.6,448C58.3,448 54.2,449.5 50.9,452.1L50.8,452.1ZM160,192C160,174.3 145.7,160 128,160C110.3,160 96,174.3 96,192C96,209.7 110.3,224 128,224C145.7,224 160,209.7 160,192ZM256,224C273.7,224 288,209.7 288,192C288,174.3 273.7,160 256,160C238.3,160 224,174.3 224,192C224,209.7 238.3,224 256,224Z" fill="yellow"/>
        </g>
        <circle id="ghost-plane" fill="yellow" cx="0" cy="0" r="10" />
        <g id="ghost-point-1">
        ...
        <g id="ghost-point-3">
            <path fill="yellow" d="M8.25,55.669L8.28,31.951C10.262,11.869 38.257,12.046 40.052,32.084C40.057,32.143 40.056,55.457 40.056,55.457C39.039,58.945 36.855,53.716 34.709,54.116C33.792,54.287 33.201,55.051 32.608,55.867C31.427,57.494 30.621,59.505 29.074,59.197C28.306,59.045 27.317,57.287 26.323,55.803C25.456,54.509 24.037,53.497 23.338,54.301C19.984,58.161 20.683,59.455 18.293,59.104C16.694,58.869 14.968,53.531 13.482,54.047C11.75,54.648 10.659,56.012 9.791,56.533C9.094,56.95 8.479,56.761 8.25,55.669Z"/>
            <ellipse fill="00002b" cx="18.216" cy="30.612" rx="3.4" ry="3.4" />
            <ellipse fill="00002b" cx="30.216" cy="30.612" rx="3.4" ry="3.4" />
        </g>
        <g id="ghost-point-4">
    ...
    <g id="reverse_ghosts" opacity="0">
        <circle id="ghost-reverse_plane" fill="#3379af" cx="0" cy="0"  />
        <circle id="ghost-reverse_point-1" fill="#3379af" cx="0" cy="0" />
        <circle id="ghost-reverse_point-2" fill="#3379af" cx="0" cy="0" />
        <circle id="ghost-reverse_point-3" fill="#3379af" cx="0" cy="0" />
        <circle id="ghost-reverse_point-4" fill="#3379af" cx="0" cy="0" />
        <circle id="ghost-reverse_point-5" fill="#3379af" cx="0" cy="0" />
        <circle id="ghost-reverse_point-6" fill="#3379af" cx="0" cy="0" />
        <circle id="ghost-reverse_point-7" fill="#3379af" cx="0" cy="0" />
        <circle id="ghost-reverse_point-8" fill="#3379af" cx="0" cy="0" />
        <circle id="ghost-reverse_point-9" fill="#3379af" cx="0" cy="0" />
        <circle id="ghost-reverse_point-10" fill="#3379af" cx="0" cy="0" />
        <circle id="ghost-reverse_point-11" fill="#3379af" cx="0" cy="0" />
        <circle id="ghost-reverse_point-12" fill="#3379af" cx="0" cy="0" />
    </g>
    ...
    <animateMotion xlinkHref="#ghost-point-1" dur="9.5s" begin="0.6s" repeatCount="indefinite" rotate="auto">
        <mpath xlinkHref="#ghost-planePath" />
    </animateMotion>
    <animateMotion xlinkHref="#ghost-point-2" dur="9s" begin="0.9s" repeatCount="indefinite" rotate="auto">
        <mpath xlinkHref="#ghost-planePath" />
    </animateMotion>
    <animateMotion xlinkHref="#ghost-solid.svg" dur="10s" begin="1.5s" repeatCount="indefinite" rotate="auto">
        <mpath xlinkHref="#ghost-planePath" />
    </animateMotion>
    <animateMotion xlinkHref="#ghost-plane-4" dur="10s" begin="12s" repeatCount="indefinite" rotate="auto">
        <mpath xlinkHref="#ghost-planePath" />
    </animateMotion>
    <animateMotion xlinkHref="#ghost-point-5" dur="9.5s" begin="11s" repeatCount="indefinite" rotate="auto">
        <mpath xlinkHref="#ghost-planePath" />
    </animateMotion>
    <animateMotion xlinkHref="#ghost-point-6" dur="9s" begin="2.5s" repeatCount="indefinite" rotate="auto">
        <mpath xlinkHref="#ghost-planePath" />
    </animateMotion>
    <animateMotion xlinkHref="#ghost-point-7" dur="10s" begin="3s" repeatCount="indefinite" rotate="auto">
        <mpath xlinkHref="#ghost-planePath" />
    </animateMotion>
    <animateMotion xlinkHref="#ghost-point-8" dur="10s" begin="4s" repeatCount="indefinite" rotate="auto">
        <mpath xlinkHref="#ghost-planePath" />
    </animateMotion>
    <animateMotion xlinkHref="#ghost-point-9" dur="9.5s" begin="5.3s" repeatCount="indefinite" rotate="auto">
        <mpath xlinkHref="#ghost-planePath" />
    </animateMotion>
    <animateMotion xlinkHref="#ghost-point-10" dur="9s" begin="5.5s" repeatCount="indefinite" rotate="auto">
        <mpath xlinkHref="#ghost-planePath" />
    </animateMotion>
    <animateMotion xlinkHref="#ghost-point-11" dur="10s" begin="9.5s" repeatCount="indefinite" rotate="auto">
        <mpath xlinkHref="#ghost-planePath" />
    </animateMotion>
    <animateMotion xlinkHref="#ghost-point-12" dur="10s" begin="10.7s" repeatCount="indefinite" rotate="auto">
        <mpath xlinkHref="#ghost-planePath" />
    </animateMotion>
    <animateMotion xlinkHref="#ghost-point-13" dur="10s" begin="9s" repeatCount="indefinite" rotate="auto">
        <mpath xlinkHref="#ghost-planePath" />
    </animateMotion>
